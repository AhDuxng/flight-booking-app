...
router.post(
  ...
  validate({ params: adminBookingParamsSchema }),
  adminController.cancelBooking,
);
router.get('/payments', validate({ query: adminListQuerySchema }), adminController.getPayments);
router.post(
  '/payments/:paymentId/process',
  validate({ params: adminPaymentParamsSchema, body: processCashPaymentSchema }),
  adminController.processCashPayment,
);
router.post(
  '/payments/:paymentId/refund',
  validate({ params: adminPaymentParamsSchema }),
  adminController.refundPayment,
);
router.get('/reviews', validate({ query: adminListQuerySchema }), adminController.getReviews);
router.patch(
  '/reviews/:reviewId',
  validate({ params: adminReviewParamsSchema, body: moderateReviewSchema }),
