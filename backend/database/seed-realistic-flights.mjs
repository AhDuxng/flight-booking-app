...
const airlines = [
  {
    id: existingAirlines.VNA,
    code: 'VNA',
    name: 'Vietnam Airlines',
    logo_url:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Vietnam_Airlines_logo.svg/200px-Vietnam_Airlines_logo.svg.png',
    country: 'Vietnam',
  },
  {
    id: existingAirlines.VJC,
    code: 'VJC',
    name: 'Vietjet Air',
    logo_url:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/VietJet_Air_logo.svg/200px-VietJet_Air_logo.svg.png',
    country: 'Vietnam',
  },
  {
    id: existingAirlines.BAV,
    code: 'BAV',
    name: 'Bamboo Airways',
    logo_url:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Bamboo_Airways_Logo.svg/200px-Bamboo_Airways_Logo.svg.png',
    country: 'Vietnam',
  },
  {
    id: existingAirlines.VKE,
    code: 'VKE',
...
const airports = [
  ...
  {
    id: 'b3000000-0000-0000-0000-000000000007',
    code: 'VDO',
  ...
  {
    id: 'b3000000-0000-0000-0000-000000000008',
    code: 'THD',
  ...
  {
    id: 'b3000000-0000-0000-0000-000000000009',
    code: 'VII',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000005',
    code: 'HND',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000006',
    code: 'KIX',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000007',
    code: 'FUK',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000008',
    code: 'PUS',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000009',
    code: 'DPS',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000010',
    code: 'CGK',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000011',
    code: 'DEL',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000012',
    code: 'BOM',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000013',
    code: 'MEL',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000014',
    code: 'PER',
    name: 'Perth Airport',
    city: 'Perth',
    country: 'Australia',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000015',
    code: 'SFO',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000016',
    code: 'FRA',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000017',
    code: 'MUC',
    name: 'Munich Airport',
    city: 'Munich',
    country: 'Germany',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000018',
    code: 'IST',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000019',
    code: 'DOH',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000020',
    code: 'DXB',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000021',
    code: 'PNH',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000022',
    code: 'SAI',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000023',
    code: 'VTE',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000024',
    code: 'MFM',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000025',
    code: 'KHH',
  ...
  {
    id: 'b4000000-0000-0000-0000-000000000026',
    code: 'HKT',
...
function fullSeatMapForFlight(flight) {
  ...
  for (let index = 0; index < capacity; index += 1) {
    ...
    seats.push({
      ...
      price:
        seatClass === 'business' ? Math.round(Number(flight.base_price) * 1.9) : flight.base_price,
    });
  }
...
function baggageForFlight(flight) {
  ...
  return [
    {
      flight_id: flight.id,
      weight_kg: international ? 23 : 15,
      price: international ? 450000 : 120000,
      description: international ? 'Checked baggage 23kg' : 'Checked baggage 15kg',
    },
    {
      flight_id: flight.id,
      weight_kg: international ? 32 : 20,
      price: international ? 750000 : 180000,
      description: international ? 'Checked baggage 32kg' : 'Checked baggage 20kg',
    },
  ];
}
...
function mealsForFlight(flight, index) {
  ...
  return [
    ...
    },
    {
      ...
      description: international
        ? 'Vegetarian main dish, dessert and drink'
...
async function ensureSeatMaps() {
  const [
    { data: databaseFlights, error: flightsError },
    { data: currentSeats, error: seatsError },
  ] = await Promise.all([
    supabase
      .from('flights')
      .select('id, base_price, available_seats, aircraft:aircrafts(total_seats)'),
  ...
  for (let index = 0; index < seatRows.length; index += 500) {
    await upsert('seats', seatRows.slice(index, index + 500), {
      onConflict: 'flight_id,seat_number',
    });
  }

  console.log(
    `seat maps repaired: ${seatRows.length} seats across ${new Set(seatRows.map((seat) => seat.flight_id)).size} flights`,
  );
}
...
await upsert('baggage_options', flights.flatMap(baggageForFlight), {
  onConflict: 'flight_id,weight_kg',
});
