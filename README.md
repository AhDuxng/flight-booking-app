...
Bản hardening concurrency, idempotency, outbox, webhook, refund và inventory được mô tả trong [CORE_HARDENING_REPORT.md](CORE_HARDENING_REPORT.md). Migration cuối cùng bắt buộc là `20260806020000_complete_booking_lifecycle.sql`.
