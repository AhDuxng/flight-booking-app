  ...
  return (
    <button
      className={cn(
        ...
        isSelected
          ? "border-primary bg-sky-blue"
          : "border-surface-variant bg-surface-container-lowest hover:border-primary-fixed-dim",
      )}
      onClick={onSelect}
      type="button"
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block truncate text-label-md font-label-md font-bold text-on-surface">
          {title}
        </span>
