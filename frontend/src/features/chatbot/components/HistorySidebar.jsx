...
export default function HistorySidebar({
  ...
  return (
    <aside
      className={cn(
        "w-72 shrink-0 flex-col border-r border-outline-variant bg-surface-container-low",
        className,
      )}
    >
      ...
      <div className="chat-scrollbar flex flex-1 flex-col overflow-y-auto p-container-padding">
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0">
                  <span className={cn("block truncate text-body-sm", isActive && "font-semibold")}>
                    {conversation.title}
                  </span>
        ...
        <div className="mt-auto border-t border-outline-variant pt-5">
          ...
          <Link
            className="flex items-center gap-2 py-2 text-body-sm text-on-surface-variant hover:text-primary"
            to="/support"
          >
